...
void LCD_TFT_ERROR_IRQHandler(void)     __attribute__((weak, alias("Default_Handler")));
...
void HDM_CEC_IRQHandler(void)           __attribute__((weak, alias("Default_Handler")));
